<template>
    <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
      ...
      <div>
        ...
        <dl class="mt-6 space-y-6 divide-y divide-gray-100 border-t border-gray-200 text-sm leading-6">
          ...
          <SwitchGroup as="div" class="flex pt-6">
            ...
            <dd class="flex flex-auto items-center justify-end">
              <Switch v-model="automaticTimezoneEnabled" :class="[automaticTimezoneEnabled ? 'bg-primary-600' : 'bg-gray-200', 'flex w-8 cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600']">
      ...
      <div>
        ...
        <dl class="mt-6 space-y-6 text-sm leading-6">
